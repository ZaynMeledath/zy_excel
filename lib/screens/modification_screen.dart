            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search in ${excelController.getHeaderName(excelController.selectedSearchColObs.value)}...',
            ...
            Row(
              children: [
                Icon(Icons.history_rounded,
                    size: 14, color: colorScheme.onSurface.withAlpha(60)),
                const SizedBox(width: 6),
                Text(
                  'Old: ',
                  style: TextStyle(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.edit_rounded,
                    size: 18, color: colorScheme.secondary.withAlpha(150)),
                contentPadding:
